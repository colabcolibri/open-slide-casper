import { ImagePlaceholder, type DesignSystem, type Page, type SlideMeta } from '@open-slide/core';

export const design: DesignSystem = {
  palette: { bg: '#FAFAF7', text: '#1A1A1A', accent: '#3B82F6' },
  fonts: {
    display: '-apple-system, BlinkMacSystemFont, "Inter", "SF Pro Display", system-ui, sans-serif',
    body: '-apple-system, BlinkMacSystemFont, "Inter", system-ui, sans-serif',
  },
  typeScale: { hero: 88, body: 26 },
  radius: 6,
};
