...
export const en: Locale = {
  ...
  slide: {
    ...
    jpgExportFailed: 'JPG export failed',
    ...
    exampleDeckBadge: 'Example',
    exampleDeckReadOnlyHint: 'Design reference — open your own slide to edit with Design or Inspect.',
    canvasFormatAria: 'Canvas format',
    canvasFormatSlide: '16∶9 slide',
    canvasFormat4x5: '4∶5 portrait',
    canvasFormatSlideShort: '16∶9',
    canvasFormat4x5Short: '4∶5',
    canvasFormatChangeFailed: 'Could not update canvas format',
