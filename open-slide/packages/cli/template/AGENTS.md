...
Keep this file short: hard rules only. All deeper guidance lives in the skills above. Entry flows also live under `.agents/workflows/` (mirrored from `@open-slide/core` at init).
